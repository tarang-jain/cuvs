  ...
  if (use_minibatch && n_init > 1) {
    ...
    for (int seed_iter = 0; seed_iter < n_init; ++seed_iter) {
      ...
      cuvs::cluster::kmeans::detail::cluster_cost(
        ...
        X_valid_const,
        centroids_const,
        raft::make_host_scalar_view(&valid_inertia),
        valid_weight_view);
    ...
    n_init                = 1;
    compute_final_inertia = params.batched.final_inertia_check;
