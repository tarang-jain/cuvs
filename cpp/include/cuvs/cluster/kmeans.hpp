...
/**
 * @brief Find clusters with k-means algorithm using batched processing of host int8 data.
 *
 * Integer inputs are converted to float during streaming; sample weights, centroids, and inertia
 * use float.
 */
void fit(raft::resources const& handle,
         const cuvs::cluster::kmeans::params& params,
...
/**
 * @brief Find clusters with k-means algorithm using batched processing of host uint8 data.
 *
 * Integer inputs are converted to float during streaming; sample weights, centroids, and inertia
 * use float.
 */
